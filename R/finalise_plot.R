...
update_points <- function(data_set, rows){
  points <- numeric(20)
...
r1 = update_points(raw_driver_results, 1)
r2 = update_points(raw_driver_results, 2)
r3 = update_points(raw_driver_results, 3)
r4 = update_points(raw_driver_results, 4)
r5 = update_points(raw_driver_results, 5)
r6 = update_points(raw_driver_results, 6)
r7 = update_points(raw_driver_results, 7)
r8 = update_points(raw_driver_results, 8)
r9 = update_points(raw_driver_results, 9)
r10 = update_points(raw_driver_results, 10)
r11 = update_points(raw_driver_results, 11)
r12 = update_points(raw_driver_results, 12)
r13 = update_points(raw_driver_results, 13)
r14 = update_points(raw_driver_results, 14)
r15 = update_points(raw_driver_results, 15)
r16 = update_points(raw_driver_results, 16)
r17 = update_points(raw_driver_results, 17)
r18 = update_points(raw_driver_results, 18)
r19 = update_points(raw_driver_results, 19)
r20 = update_points(raw_driver_results, 20)
r21 = update_points(raw_driver_results, 21)
...
ggplot() + 
  ...
  ylab('Drivers Championship')+xlab('Race')+ggtitle("2019 F1 Driver Championship") +
